...
if("TRUE" STREQUAL "TRUE")
  set(opencv_test_SOURCE_PREFIX /home/rvmi/catkin_ws/src/opencv_test)
  set(opencv_test_DEVEL_PREFIX /home/rvmi/catkin_ws/devel/.private/opencv_test)
  ...
  set(opencv_test_INSTALL_PREFIX /home/rvmi/catkin_ws/install)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'opencv_test' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  ${_report}")
      endif()
    else()
      message(FATAL_ERROR "Project 'opencv_test' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/rvmi/catkin_ws/src/opencv_test/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/rvmi/catkin_ws/devel/.private/opencv_test/lib;/home/rvmi/catkin_ws/devel/lib;/opt/ros/kinetic/lib)
...
set(opencv_test_EXPORTED_TARGETS "")
...
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${opencv_test_dep}_FOUND)
      find_package(${opencv_test_dep} REQUIRED NO_MODULE)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${opencv_test_dep} REQUIRED NO_MODULE ${depend_list})
  endif()
