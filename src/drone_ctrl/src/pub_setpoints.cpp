...
int main(int argc, char **argv)
{
   ...
   while(ros::ok()){
       ...
       msg.pose.position.x = 6.0;//0.001*some_object.position_x;
       msg.pose.position.y = 5.0;//0.001*some_object.position_y;
       msg.pose.position.z = 4.0;//0.001*some_object.position_z;
